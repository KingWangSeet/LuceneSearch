			...
			<div class="top_c">
				<div class="top-menu">
					<ul class="top-menu-nav">
						<li>
							<a target="Conframe"
								href="${pageContext.request.contextPath}/page/common/main-t.jsp">首页</a>
						</li>
							...
							<ul class="kidc">
								<li>
									<b class="tip"></b><a target="Conframe"
										href="index/initProteinSearch.action?rol=0">蛋白质信息</a>
								</li>
								<li>
									<b class="tip"></b><a target="Conframe"
										href="index/initIndexSearch.action?rol=0">索引信息管理</a>
								</li>
							</ul>
						</li>
						<li>
