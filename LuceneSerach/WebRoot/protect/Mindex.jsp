			...
			<div class="top_c">
				<div class="top-menu">
					<ul class="top-menu-nav">
						<li>
							<a target="Conframe"
								href="${pageContext.request.contextPath}/page/common/main-t.jsp">管理员首页</a>
						</li>

						<li>
							<a href="#">基础信息管理<i class="tip-up"></i> </a>
							<ul class="kidc">
								<li>
									<b class="tip"></b><a target="Conframe"
										href="index/initProteinSearch.action?rol=1">蛋白质信息</a>
								</li>
								<li>
									<b class="tip"></b><a target="Conframe"
										href="index/initIndexSearch.action?rol=1">索引信息管理</a>
								</li>
								<li>
									<b class="tip"></b><a target="Conframe"
										href="user/initSearch.action?rol=1">人员信息管理</a>
								</li>
							</ul>
						</li>
						<li>
